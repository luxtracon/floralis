...
public class FloralisModelProvider extends ModelProvider {
	...
	public static Identifier blockFile(Block pBlock, String pSuffix, String pSourceA, String pTargetA, String pSourceB, String pTargetB) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.blockId(pBlock), "block" + "/" + FloralisModelProvider.blockName(pBlock).replace(pSourceA, pTargetA).replace(pSourceB, pTargetB) + "_" + pSuffix);
	}

	public static Identifier blockFile(Block pBlock, String pSuffix, String pSource, String pTarget) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.blockId(pBlock), "block" + "/" + FloralisModelProvider.blockName(pBlock).replace(pSource, pTarget) + "_" + pSuffix);
	}

	public static Identifier blockFile(Block pBlock, String pSuffix) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.blockId(pBlock), "block" + "/" + FloralisModelProvider.blockName(pBlock) + "_" + pSuffix);
	}

	public static Identifier blockFile(Block pBlock, String pSourceA, String pTargetA, String pSourceB, String pTargetB) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.blockId(pBlock), "block" + "/" + FloralisModelProvider.blockName(pBlock).replace(pSourceA, pTargetA).replace(pSourceB, pTargetB));
	}

	public static Identifier blockFile(Block pBlock, String pSource, String pTarget) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.blockId(pBlock), "block" + "/" + FloralisModelProvider.blockName(pBlock).replace(pSource, pTarget));
	}

	public static Identifier blockFile(Block pBlock) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.blockId(pBlock), "block" + "/" + FloralisModelProvider.blockName(pBlock));
	}
	...
	public static Identifier blockFile(String pPrefix, Block pBlock, String pSuffix, String pSourceA, String pTargetA, String pSourceB, String pTargetB) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.blockId(pBlock), "block" + "/" + pPrefix + "_" + FloralisModelProvider.blockName(pBlock).replace(pSourceA, pTargetA).replace(pSourceB, pTargetB) + "_" + pSuffix);
	}

	public static Identifier blockFile(String pPrefix, Block pBlock, String pSuffix, String pSource, String pTarget) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.blockId(pBlock), "block" + "/" + pPrefix + "_" + FloralisModelProvider.blockName(pBlock).replace(pSource, pTarget) + "_" + pSuffix);
	}

	public static Identifier blockFile(String pPrefix, Block pBlock, String pSuffix) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.blockId(pBlock), "block" + "/" + pPrefix + "_" + FloralisModelProvider.blockName(pBlock) + "_" + pSuffix);
	}
	...
	public static Identifier blockFile(String pPrefix, Block pBlock, String pSourceA, String pTargetA, String pSourceB, String pTargetB) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.blockId(pBlock), "block" + "/" + pPrefix + "_" + FloralisModelProvider.blockName(pBlock).replace(pSourceA, pTargetA).replace(pSourceB, pTargetB));
	}

	public static Identifier blockFile(String pPrefix, Block pBlock, String pSource, String pTarget) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.blockId(pBlock), "block" + "/" + pPrefix + "_" + FloralisModelProvider.blockName(pBlock).replace(pSource, pTarget));
	}

	public static Identifier blockFile(String pPrefix, Block pBlock) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.blockId(pBlock), "block" + "/" + pPrefix + "_" + FloralisModelProvider.blockName(pBlock));
	}
	...
	public static Identifier itemFile(Item pItem, String pSuffix, String pSourceA, String pTargetA, String pSourceB, String pTargetB) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.itemId(pItem), "item" + "/" + FloralisModelProvider.itemName(pItem).replace(pSourceA, pTargetA).replace(pSourceB, pTargetB) + "_" + pSuffix);
	}

	public static Identifier itemFile(Item pItem, String pSuffix, String pSource, String pTarget) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.itemId(pItem), "item" + "/" + FloralisModelProvider.itemName(pItem).replace(pSource, pTarget) + "_" + pSuffix);
	}

	public static Identifier itemFile(Item pItem, String pSuffix) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.itemId(pItem), "item" + "/" + FloralisModelProvider.itemName(pItem) + "_" + pSuffix);
	}

	public static Identifier itemFile(Item pItem, String pSourceA, String pTargetA, String pSourceB, String pTargetB) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.itemId(pItem), "item" + "/" + FloralisModelProvider.itemName(pItem).replace(pSourceA, pTargetA).replace(pSourceB, pTargetB));
	}

	public static Identifier itemFile(Item pItem, String pSource, String pTarget) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.itemId(pItem), "item" + "/" + FloralisModelProvider.itemName(pItem).replace(pSource, pTarget));
	}

	public static Identifier itemFile(Item pItem) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.itemId(pItem), "item" + "/" + FloralisModelProvider.itemName(pItem));
	}
	...
	public static Identifier itemFile(String pPrefix, Item pItem, String pSuffix, String pSourceA, String pTargetA, String pSourceB, String pTargetB) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.itemId(pItem), "item" + "/" + pPrefix + "_" + FloralisModelProvider.itemName(pItem).replace(pSourceA, pTargetA).replace(pSourceB, pTargetB) + "_" + pSuffix);
	}

	public static Identifier itemFile(String pPrefix, Item pItem, String pSuffix, String pSource, String pTarget) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.itemId(pItem), "item" + "/" + pPrefix + "_" + FloralisModelProvider.itemName(pItem).replace(pSource, pTarget) + "_" + pSuffix);
	}

	public static Identifier itemFile(String pPrefix, Item pItem, String pSuffix) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.itemId(pItem), "item" + "/" + pPrefix + "_" + FloralisModelProvider.itemName(pItem) + "_" + pSuffix);
	}
	...
	public static Identifier itemFile(String pPrefix, Item pItem, String pSourceA, String pTargetA, String pSourceB, String pTargetB) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.itemId(pItem), "item" + "/" + pPrefix + "_" + FloralisModelProvider.itemName(pItem).replace(pSourceA, pTargetA).replace(pSourceB, pTargetB));
	}

	public static Identifier itemFile(String pPrefix, Item pItem, String pSource, String pTarget) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.itemId(pItem), "item" + "/" + pPrefix + "_" + FloralisModelProvider.itemName(pItem).replace(pSource, pTarget));
	}

	public static Identifier itemFile(String pPrefix, Item pItem) {
		return Identifier.fromNamespaceAndPath(FloralisModelProvider.itemId(pItem), "item" + "/" + pPrefix + "_" + FloralisModelProvider.itemName(pItem));
	}
