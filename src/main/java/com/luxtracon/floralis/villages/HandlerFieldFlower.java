...
public class HandlerFieldFlower implements IVillageCreationHandler
{
    @Override
    public Class<? extends Village> getComponentClass()
    {
        return StructureFieldFlower.class;
    }
    ...
    {
        return StructureFieldFlower.createPiece(start, pieces, random, x, y, z, facing, type);
    }
}