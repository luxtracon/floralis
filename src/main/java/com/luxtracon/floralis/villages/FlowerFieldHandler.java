...
public class FlowerFieldHandler implements IVillageCreationHandler
{
    @Override
    ...
    {
        return FlowerFieldStructure.class;
    }
    ...
    {
        return FlowerFieldStructure.createPiece(start, pieces, random, x, y, z, facing, type);
    }
}