...
{
    public static FlowerBase flowerWhite;
    public static FlowerBase flowerOrange;
    public static FlowerBase flowerMagenta;
    public static FlowerBase flowerLightBlue;
    public static FlowerBase flowerYellow;
    public static FlowerBase flowerLime;
    public static FlowerBase flowerPink;
    public static FlowerBase flowerGray;
    public static FlowerBase flowerLightGray;
    public static FlowerBase flowerCyan;
    public static FlowerBase flowerPurple;
    public static FlowerBase flowerBlue;
    public static FlowerBase flowerBrown;
    public static FlowerBase flowerGreen;
    public static FlowerBase flowerRed;
    public static FlowerBase flowerBlack;
