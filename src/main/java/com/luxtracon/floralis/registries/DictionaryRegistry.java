...
public class DictionaryRegistry
{
    public static void init()
    {
        ...
        OreDictionary.registerOre("seedFlowerCyan", new ItemStack(ItemInit.seedFlowerCyan));
        OreDictionary.registerOre("seedFlowerGray", new ItemStack(ItemInit.seedFlowerGray));
        OreDictionary.registerOre("seedFlowerGreen", new ItemStack(ItemInit.seedFlowerGreen));
        OreDictionary.registerOre("seedFlowerLightBlue", new ItemStack(ItemInit.seedFlowerLightBlue));
        OreDictionary.registerOre("seedFlowerLightGray", new ItemStack(ItemInit.seedFlowerLightGray));
        OreDictionary.registerOre("seedFlowerLime", new ItemStack(ItemInit.seedFlowerLime));
        OreDictionary.registerOre("seedFlowerMagenta", new ItemStack(ItemInit.seedFlowerMagenta));
        OreDictionary.registerOre("seedFlowerOrange", new ItemStack(ItemInit.seedFlowerOrange));
        OreDictionary.registerOre("seedFlowerPink", new ItemStack(ItemInit.seedFlowerPink));
        OreDictionary.registerOre("seedFlowerPurple", new ItemStack(ItemInit.seedFlowerPurple));
