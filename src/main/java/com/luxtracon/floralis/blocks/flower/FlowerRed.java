...
public class FlowerRed extends BaseFlower implements IShearable
{
    ...
    {
        drops.add(new ItemStack(InitItem.petalRed, RANDOM.nextInt(2) + 1 + fortune));
        drops.add(new ItemStack(InitItem.seedRed, RANDOM.nextInt(2) + 1 + fortune));
    }
    ...
    {
        return java.util.Arrays.asList(new ItemStack(InitFlower.flowerRed));
    }
}