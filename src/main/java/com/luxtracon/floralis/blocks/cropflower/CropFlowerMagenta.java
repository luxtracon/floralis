...
public class CropFlowerMagenta extends FlowerCropBase
{
    public CropFlowerMagenta(String name)
    {
        super(name);
    }
    ...
    {
        return ItemInit.seedFlowerMagenta;
    }

    @Override
    protected Item getCrop()
    {
        return ItemInit.petalMagenta;
    }
