...
public class CropFlowerLightGray extends BaseCropFlower
{
    public CropFlowerLightGray(String name)
    {
        super(name);
    }
    ...
    {
        return InitItem.seedFlowerLightGray;
    }

    @Override
    protected Item getCrop()
    {
        return InitItem.petalLightGray;
    }
