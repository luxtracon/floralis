...
public class CropCactusMagenta extends BaseCropCactus
{
    public CropCactusMagenta(String name)
    {
        super(name);
    }
    ...
    {
        return InitItem.seedCactusMagenta;
    }

    @Override
    protected Item getCrop()
    {
        return InitItem.petalMagenta;
    }
