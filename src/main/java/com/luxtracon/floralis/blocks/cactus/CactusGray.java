...
public class CactusGray extends CactusBase implements IShearable
{
    public CactusGray(String name, Material material)
    {
        super(name, material);
    }
    ...
    {
        return Arrays.asList(new ItemStack(CactusInit.cactusGray));
    }
}