...
public class CactusBlue extends CactusBase implements IShearable
{
    public CactusBlue(String name, Material material)
    {
        super(name, material);
    }
    ...
    {
        return Arrays.asList(new ItemStack(CactusInit.cactusBlue));
    }
}