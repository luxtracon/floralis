...
public class CactusBlack extends CactusBase implements IShearable
{
    public CactusBlack(String name, Material material)
    {
        super(name, material);
    }
    ...
    {
        return Arrays.asList(new ItemStack(CactusInit.cactusBlack));
    }
}