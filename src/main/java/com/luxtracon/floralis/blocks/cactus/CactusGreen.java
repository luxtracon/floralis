...
public class CactusGreen extends CactusBase implements IShearable
{
    public CactusGreen(String name, Material material)
    {
        super(name, material);
    }
    ...
    {
        return Arrays.asList(new ItemStack(CactusInit.cactusGreen));
    }
}