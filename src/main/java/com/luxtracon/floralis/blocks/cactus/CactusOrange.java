...
public class CactusOrange extends CactusBase implements IShearable
{
    public CactusOrange(String name, Material material)
    {
        super(name, material);
    }
    ...
    {
        return Arrays.asList(new ItemStack(CactusInit.cactusOrange));
    }
}