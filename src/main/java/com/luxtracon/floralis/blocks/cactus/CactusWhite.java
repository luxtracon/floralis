...
public class CactusWhite extends CactusBase implements IShearable
{
    public CactusWhite(String name, Material material)
    {
        super(name, material);
    }
    ...
    {
        return Arrays.asList(new ItemStack(CactusInit.cactusWhite));
    }
}