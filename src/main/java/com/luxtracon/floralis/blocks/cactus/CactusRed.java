...
public class CactusRed extends BaseCactus
{
    public CactusRed(String name, Material material, float hardness, float resistance)
    {
    ...
    {
        drops.add(new ItemStack(InitItem.seedCactusRed, 2 + fortune));
