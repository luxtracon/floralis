...
public class CactusRed extends CactusBase implements IShearable
{
    public CactusRed(String name, Material material)
    {
        super(name, material);
    }
    ...
    {
        return Arrays.asList(new ItemStack(CactusInit.cactusRed));
    }
}