...
public class CactusYellow extends CactusBase implements IShearable
{
    public CactusYellow(String name, Material material)
    {
        super(name, material);
    }
    ...
    {
        return Arrays.asList(new ItemStack(CactusInit.cactusYellow));
    }
}