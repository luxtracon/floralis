...
public class CactusLime extends CactusBase implements IShearable
{
    public CactusLime(String name, Material material)
    {
        super(name, material);
    }
    ...
    {
        return Arrays.asList(new ItemStack(CactusInit.cactusLime));
    }
}