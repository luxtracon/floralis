...
public class CactusCyan extends CactusBase implements IShearable
{
    public CactusCyan(String name, Material material)
    {
        super(name, material);
    }
    ...
    {
        return Arrays.asList(new ItemStack(CactusInit.cactusCyan));
    }
}