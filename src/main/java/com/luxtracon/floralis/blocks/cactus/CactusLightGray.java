...
public class CactusLightGray extends CactusBase implements IShearable
{
    public CactusLightGray(String name, Material material)
    {
        super(name, material);
    }
    ...
    {
        return Arrays.asList(new ItemStack(CactusInit.cactusLightGray));
    }
}