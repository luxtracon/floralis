...
public class CactusPurple extends CactusBase implements IShearable
{
    public CactusPurple(String name, Material material)
    {
        super(name, material);
    }
    ...
    {
        return Arrays.asList(new ItemStack(CactusInit.cactusPurple));
    }
}