...
public class CactusPink extends CactusBase implements IShearable
{
    public CactusPink(String name, Material material)
    {
        super(name, material);
    }
    ...
    {
        return Arrays.asList(new ItemStack(CactusInit.cactusPink));
    }
}